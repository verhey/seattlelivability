    ...
    <script type="text/javascript">
        function initViz() {
            var containerDiv = document.getElementById("vizContainer"),
                url = "https://public.tableau.com/views/SeattleLivability_Rent/Dashboard1",
                options = {
...
<div class="container">
    <div class="row">
        <div class="col-12">
            <?php if($neighborhood != "") echo "<a href='viz_rent.php'><h4 class='text-center'>Remove Filters</h4></a>"; ?>
